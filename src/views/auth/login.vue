        ...
        <div class="login_forgotPw">
          <b-row>
            ...
            <div class="col-12 col-md-6 login">
              <b-row>
                <div class="text col-12">
                  <span>Nếu bạn đã có tài khoản, đăng nhập tại đây. Hoặc </span
                ...
                <div class="email_pass col-12">
                  ...
                  <div class="buttons-coll">
                    <button
                      type="submit"
                      class="custom_btn btn_submit btn_login"
                      @mousedown="login()"
                    >
                      <span
            ...
            <div class="col-12 col-md-6 forgotPw">
              <div class="text col-12">
                <span
                  >Bạn quên mật khẩu? Nhập địa chỉ email để lấy mật khẩu qua
                  email.</span
                >
              </div>
              <div class="forgot_pass">
                <form action="">
                  ...
                  <div class="buttons-coll">
                    <button class="custom_btn btn_submit">
  ...
  methods: {
    ...
    validate_form() {
      ...
      if (this.email.trim().length == 0 || this.password.trim().length == 0) {
        ...
        this.validate = "Tài khoản hoặc mật khẩu không đúng";
      }
    },
    login() {
      this.validate_form();
