              ...
              <div class="index_news" @mousedown="view_news(news)">
                ...
                <div class="text">
                  <div class="title_news">
                    <router-link :to="link_view"
                      ><h6>{{ news.title_introduce }}</h6></router-link
                    >
                  </div>
                  <div class="content_news">
                    <p>{{ news.content_introduce }}</p>
                  </div>
                  <router-link :to="link_view" class="info"
