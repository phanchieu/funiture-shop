        ...
        <div class="row" v-for="(product, index) in info_product" :key="index">
          <div class="col-12 col-md-6">
            <div class="img_product">
              <img
                :src="require(`@/${product.view_img_product[view_img]}`)"
                alt=""
              />
            </div>
            <div class="slide_img">
              ...
              <VueSlickCarousel v-bind="settings">
                <img
                  v-for="(slide_img, i) in product.view_img_product"
                  :key="i"
                  :src="require(`@/${slide_img}`)"
                  @click="change_img(i)"
                />
              </VueSlickCarousel>
            </div>
          ...
          <div class="col-12 col-md-6">
            <div class="info_product">
              ...
              <div
                class="introduce_product"
                :class="{ view_introduce: view_introduce == true }"
              >
              ...
              <div class="select_info">
                ...
                <div class="size">
                  ...
                  <select v-model="Data.size">
                    <option value="" selected disabled
                      >vui lòng chọn kích thước</option
                    >
                    <option v-for="(size, i) in product.sizes" :key="i">{{
                      size
                    }}</option>
                  </select>
                </div>
                ...
                <div class="buttons-coll">
                  <button class="custom-btn btn-3" @click="pushData()">
        ...
        <div class="container">
          <div class="rowo">
            ...
            <div class="tab_content">
              <ul>
                <transition name="fade">
                  <li class="content" v-if="tab == 1">
                    <p>Đang cập nhật...</p>
                  </li>
                </transition>
                <transition name="fade">
                  <li class="content" v-if="tab == 2">
                    <p>Đang cập nhật...</p>
                  </li>
                </transition>
                <transition name="fade">
                  <li class="content" v-if="tab == 3">
                    <p>Đang cập nhật...</p>
                  </li>
                </transition>
              </ul>
...
export default {
  ...
  methods: {
    ...
    ...mapMutations(["viewProduct", "relatedProducts_mutations", "updateCart"]),
    test() {
      var a = this.product();
      console.log(a);
    },
    ...
    pushData() {
      ...
      this.Data.into_money =
        this.info_product[0].price * this.info_product[0].quantity;
