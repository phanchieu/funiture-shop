          ...
          <div class="banner_and_product col-12 col-lg-9">
            <!-- <div class="banner">
              <img
                ...
                alt=""
              />
              <div class="title"><h1>Tìm kiếm sản phẩm</h1></div>
            </div> -->
            <div class="filter">
              <span>Sắp xếp</span>
...
export default {
  ...
  computed: {
    ...mapGetters(["search_product", "fil_color", "fil_size", "fil_material"]),
    computedProducts: function() {
      ...
      return this.products.filter((item) => {
        return (
          (this.search_product.trim().length === 0 ||
            item.name
              .toLowerCase()
  ...
  methods: {
    ...
    get_product() {
      var all_product = this.all_prd();
      this.products = all_product.all_products;
